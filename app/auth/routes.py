...
#             return render_template('auth/login.html', error='Email y contraseña requeridos')
...
#         # Para peticiones de formulario (HTML)
...
#         response.set_cookie('user_rol', user['rol'], max_age=86400)
#         return response
...
#         user_id = user_model.create_user(nombre, email, password, 'cliente')
...
#         # Eliminar cookies con todas las opciones
